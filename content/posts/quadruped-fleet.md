+++
title = 'Collaborative SLAM for Quadruped Fleet'
date = 2025-03-14
draft = false
+++
...
The initial relative position of both agents are known and I also have the IMU data of the motion series, which can be stiched into a combined map. The work is based on the [**research**](https://github.com/robo-friends/m-explore-ros2).
